...
china_map_province <- rgdal::readOGR("D:/R_codes_for_nat.pla_in.China/data/China_map/bou2_4p.shp", stringsAsFactors = FALSE)
...
# --------------------------------------------------------------------------
summary_province_alien <- read.csv("D:/R_codes_for_nat.pla_in.China/data/no.alien.pla_in_provinces.of.China.csv")
...
# --------------------------------------------------------------------------
species.legend.title_alien <- "No. alien plants"
...
# --------------------------------------------------------------------------
summary_province_nat <- read.csv("D:/R_codes_for_nat.pla_in.China/data/no.nat.pla_in_provinces.of.China.csv")
...
# exporting map
ggexport(species.ggmap_province01, filename = "D:/R_codes_for_nat.pla_in.China/Results/sp_province_plot_both.png",
         width = 7000,
         height = 8000,
         pointsize = 12,
         res = 600)