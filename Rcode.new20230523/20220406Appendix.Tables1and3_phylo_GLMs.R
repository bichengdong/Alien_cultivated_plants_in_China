...
# @Last Modified by:
# @Last Modified time: 2022-03-25 16:30:14
...
# --------------------------------------------------------------------------
# appendix table 1
# climatic suitability, hab_suit_prop_max (variable name in phylogenetic glms)
# --------------------------------------------------------------------------
# remove hab_suit_prop_max with NA values
checklist_Invspc_new_01_hab_suit <- checklist_Invspc_new_01[!is.na(checklist_Invspc_new_01$hab_suit_prop_max),]
...
# model fitting
model_phylo_hab_suit <- phyloglm(naturalized_status ~ hab_suit_prop_max, phy = phylo_Tree_01_hab_suit, btol = 10, data = checklist_Invspc_new_01_hab_suit)
...
write.csv(summary_phylo_output.new, "D:/R_codes_for_nat.pla_in.China/Results/Appendix.tables.1and3.phylo_glms_without_intercept.csv")
