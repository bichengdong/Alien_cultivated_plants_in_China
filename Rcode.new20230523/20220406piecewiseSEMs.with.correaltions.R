...
# @Last Modified by:
# @Last Modified time: 2022-04-13 14:36:35
...
# hab_suit_prop_max: climatic suitability, 0-1; cs in SEMs
...
length(checklist_Invspc_new$hab_suit_prop_max[!is.na(checklist_Invspc_new$hab_suit_prop_max)])
...
checklist_Invspc_new$cs <- scale(log(checklist_Invspc_new$hab_suit_prop_max + 0.001))
...
write.csv(coefs(mod_short_lived02_with.correlation),"D:/R_codes_for_nat.pla_in.China/Results/SEMs_for_short.lived_with.correlation.csv", row.names = FALSE)
...
write.csv(coefs(mod_long_lived02_with.correlation),"D:/R_codes_for_nat.pla_in.China/Results/SEMs_for_long.lived_with.correlation.csv", row.names = FALSE)
...
write.csv(coefs(mod_woody02_with.correlation02),"D:/R_codes_for_nat.pla_in.China/Results/SEMs_for_woody_with.correlation.csv", row.names = FALSE)
