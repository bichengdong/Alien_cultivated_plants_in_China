...
# @Last Modified by:
# @Last Modified time: 2022-03-25 16:30:52
...
checklist_Invspc_new <- read_csv("D:/R_codes_for_nat.pla_in.China/data/checklist_nat.pla_in_China.csv")
...
# save plots
ggexport(mixed_fig, filename = "D:/R_codes_for_nat.pla_in.China/Results/Figure.1.png",
          width = 2400,
          height = 4000,
          pointsize = 12,
          res = 300)
